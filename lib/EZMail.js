...
var Thread     = require('Threads').Thread,
    ...
    SMTPMXMail = Packages.org.mcro.smtpmxmail.SMTPMXMail;
...
decaf.extend(EZMail.prototype, {
    ...
    isEmailExisting: function(email) {
        try {
            return SMTPMXMail.isAddressValid((String)(email)); // cast on a String
        }
        catch (e) {
            console.log('isEmailExisting ' + email);
